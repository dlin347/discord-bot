...
module.exports = async function addMoney(interaction) {
    ...
    const responses = localeFile.categories.economy.commands.addmoney.responses;
    ...
    try {
        ...
        await interaction.reply({
            ...
            console.error("\x1b[31m" + '[/ADD-MONEY] ' + e.stack + "\x1b[0m");
