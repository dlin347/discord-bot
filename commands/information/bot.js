    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                // Pending { name: responsesEmbed.uptime, value: `<t:${uptimeTimestamp}:F> (<t:${uptimeTimestamp}:R>)` },
                { name: responsesEmbed.users, value: await client.users.cache.size.toString() },
                { name: responsesEmbed.guilds, value: await client.guilds.cache.size.toString() },
                { name: responsesEmbed.channels, value: await client.channels.cache.size.toString() },
